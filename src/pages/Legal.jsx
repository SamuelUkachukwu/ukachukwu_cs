...
const Sitemap = () => <div className="z-10 w-[74%] mx-auto space-y-6 pt-30 ">Sitemap Content</div>;
const PrivacyPolicy = () => {
    ...
    return (
        <>
            <div className="z-10 w-[74%] mx-auto space-y-6 pt-30">
                {/* Title */}
                <h1 className="text-2xl md:text-4xl font-bold tracking-tight rounded-2xl bg-gray-100 dark:bg-gray-800 p-4 shadow">
                    {p.title}
                </h1>
                ...
                <section>
                    ...
                    <p>{renderTextWithLinks(p.interpretationAndDefinitions.interpretation)}</p>
                ...
                <section>
                    ...
                    <p className="mt-4">{renderTextWithLinks(p.dataCollection.usageData)}</p>
                ...
                <section>
                    ...
                    <h2 className="text-2xl font-semibold mt-8 mb-4">Data Deletion</h2>
                    <p>{renderTextWithLinks(p.deletion)}</p>
                </section>

                {/* Disclosure */}
                <section>
                    <h2 className="text-2xl font-semibold mt-8 mb-4">Disclosure</h2>
                    <p>{renderTextWithLinks(p.disclosure.businessTransactions)}</p>
                    <p className="mt-2">{renderTextWithLinks(p.disclosure.lawEnforcement)}</p>
...
const AccessibilityStatement = () => <div className="z-10 w-[74%] mx-auto space-y-6 pt-30 ">Accessibility Statement Content</div>;
...
const Legal = () => {
    ...
    const content = documents[docType] || <div>Document not found Please try again later.</div>;
